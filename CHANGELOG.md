...
### ✨ Added
- 🏗️ **Widget Event Channel**: `ShowProfileRequest.widgetEventCallback` receives events posted from the widget (e.g. game completion) as a `Map<String, Object>` `{type, metadata}`
